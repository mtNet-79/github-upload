...
from forms import *
import sys
from models import db, Venue, Artist, Genre, City, Show
#----------------------------------------------------------------------------#
# App Config.
#----------------------------------------------------------------------------#
...
def create_venue_submission():
  ...
  try:
    ...
    city_id = None
    city_exists = City.query.filter_by(city=city).first()
    if city_exists is None:      
      try:
        new_city= City(city, state)
      ...
      if error:
        ...
        city_id = City.query.filter_by(city=city).first().id
    else:
      city_id = city_exists.id
    for genre in genres:
      print(genre)
    # venue = Venue(name=name, city_id=city_id, state=state,address=address, phone=phone,image_link=image_link, facebook_link=facebook_link,
    #   seeking_talent=seeking_talent,seeking_description=seeking_description,website=website_link, 
    # )
  except:
